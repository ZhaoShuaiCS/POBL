...
func createChain(
	...
	//zs
	err=ledger.SetLocalDeliverService(bundle.ConfigtxValidator().ChainID())
	if err!=nil{
		peerLogger.Infof("zs:chainid:%s err in ledger.SetLocalDeliverService(bundle.ConfigtxValidator().ChainID()) err:%s",bundle.ConfigtxValidator().ChainID(),err)
	}else{
		peerLogger.Infof("zs:chainid:%s success in ledger.SetLocalDeliverService(bundle.ConfigtxValidator().ChainID())",bundle.ConfigtxValidator().ChainID())
	}
	//zs
