...
//zs
// func GetTxnResult(txActions *peer.TransactionAction) (int64, string,*peer.ChaincodeActionPayload, *peer.ChaincodeAction, error) {
// 	// TODO: pass in the tx type (in what follows we're assuming the
// 	// type is ENDORSER_TRANSACTION)
// 	ccPayload, err := GetChaincodeActionPayload(txActions.Payload)
// 	if err != nil {
// 		return -1,"error",nil, nil, err
// 	}

// 	if ccPayload.Action == nil || ccPayload.Action.ProposalResponsePayload == nil {
// 		return -1,"error",nil, nil, errors.New("no payload in ChaincodeActionPayload")
// 	}
// 	pRespPayload, err := GetProposalResponsePayload(ccPayload.Action.ProposalResponsePayload)
// 	if err != nil {
// 		return -1,"error",nil, nil, err
...
// 	if pRespPayload.Extension == nil {
// 		return -1,"error",nil, nil, errors.New("response payload is missing extension")
// 	}
...
// 		return -1,"error",nil, nil, err
// 	}
// 	return pRespPayload.GetTxnCount(), pRespPayload.GetTxid(),ccPayload, respPayload,nil


// }

// func GetTxnCountPayloads(txActions *peer.TransactionAction) (int64, string) {
// 	// TODO: pass in the tx type (in what follows we're assuming the
// 	// type is ENDORSER_TRANSACTION)
// 	ccPayload, err := GetChaincodeActionPayload(txActions.Payload)
// 	if err != nil {
...
// 	return pRespPayload.GetTxnCount(), pRespPayload.GetTxid()
...
//zs
func LocalCreateSignedTx(proposal *peer.Proposal, signer msp.SigningIdentity, resps ...*peer.ProposalResponse) (*common.Envelope, error) {
	if len(resps) == 0 {
...
func CreateProposalResponse(hdrbytes []byte, payl []byte, response *peer.Response, results []byte, events []byte, ccid *peer.ChaincodeID, visibility []byte, signingEndorser msp.SigningIdentity) (*peer.ProposalResponse, error) {
	...
	//prpBytes, err := GetBytesProposalResponsePayload(pHashBytes, response, results, events, ccid,-1,"error")
